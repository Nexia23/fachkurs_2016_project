...
class ModelData:
    ...
    def createchromosomes():
        ...
        chr1=mol.Chromosome("Chr 1",arf[0],"fsa_sequences/S288C_Chromosome I.fsa")
        chr2=mol.Chromosome("Chr 2",arf[1],"fsa_sequences/S288C_Chromosome II.fsa")
        chr3=mol.Chromosome("Chr 3",arf[2],"fsa_sequences/S288C_Chromosome III.fsa")
        chr4=mol.Chromosome("Chr 4",arf[3],"fsa_sequences/S288C_Chromosome IV.fsa")
        chr5=mol.Chromosome("Chr 5",arf[4],"fsa_sequences/S288C_Chromosome V.fsa")
        chr6=mol.Chromosome("Chr 6",arf[5],"fsa_sequences/S288C_Chromosome VI.fsa")
        chr7=mol.Chromosome("Chr 7",arf[6],"fsa_sequences/S288C_Chromosome VII.fsa")
        chr8=mol.Chromosome("Chr 8",arf[7],"fsa_sequences/S288C_Chromosome VIII.fsa")
        chr9=mol.Chromosome("Chr 9",arf[8],"fsa_sequences/S288C_Chromosome IX.fsa")
        chr10=mol.Chromosome("Chr 10",arf[9],"fsa_sequences/S288C_Chromosome X.fsa")
        chr11=mol.Chromosome("Chr 11",arf[10],"fsa_sequences/S288C_Chromosome XI.fsa")
        chr12=mol.Chromosome("Chr 12",arf[11],"fsa_sequences/S288C_Chromosome XII.fsa")
        chr13=mol.Chromosome("Chr 13",arf[12],"fsa_sequences/S288C_Chromosome XIII.fsa")
        chr14=mol.Chromosome("Chr 14",arf[13],"fsa_sequences/S288C_Chromosome XIV.fsa")
        chr15=mol.Chromosome("Chr 15",arf[14],"fsa_sequences/S288C_Chromosome XV.fsa")
        chr16=mol.Chromosome("Chr 16",arf[15],"fsa_sequences/S288C_Chromosome XVI.fsa")
        chrmito=mol.Chromosome("Chr 17",arf[16],"fsa_sequences/S288C_Chromosome Mito.fsa")
